...
export class ProblemsController {
  ...
  @Get()
  @ApiOperation({ summary: '取得題目清單', description: '列出所有公開題目，支援分頁與難度篩選' })
  ...
  @Get(':id')
  @ApiOperation({ summary: '取得題目詳情', description: '取得單一題目完整描述，不含隱藏測資' })
  ...
  @Roles('ADMIN')
  @ApiBearerAuth()
  @ApiOperation({ summary: '新增題目 (Admin)', description: '管理員新增題目，包含測試資料' })
  ...
  @Roles('ADMIN')
  @ApiBearerAuth()
  @ApiOperation({ summary: '指派題目 (Admin)', description: '將題目指定給特定使用者' })
