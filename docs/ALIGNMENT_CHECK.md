...
├── DATABASE_SCHEMA.md            ✓ 9.9KB - 資料庫模式
...
| `npm run start:dev`        | 開發模式     | ✅ SETUP_GUIDE      | 監視模式         |
| `npm run start:debug`      | 調試模式     | ✅ TESTING_GUIDE    | Node.js 檢查     |
...
| `npm run test:watch`       | 觀察模式     | ✅ TESTING_GUIDE    | 自動重跑         |
...
| /health/live                          | GET    | ✅ API_SPECIFICATION | ✓    | Liveness                 |
| /health/ready                         | GET    | ✅ API_SPECIFICATION | ✓    | Readiness                |
