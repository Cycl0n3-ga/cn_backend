...
| 21 | `DELETE` | `/interview-candidates/:id` | 🔒 USER+ | 移除面試者 |
| 22 | `POST` | `/assignments` | 🔒 USER+ | 指派題目給考生 |
| 23 | `GET` | `/assignments` | ❌ | 取得題目指派列表 |
| 24 | `GET` | `/assignments/user/:userId` | ❌ | 取得特定使用者的指派 |
| 25 | `GET` | `/assignments/:id` | ❌ | 取得單一指派 |
| 26 | `DELETE` | `/assignments/:id` | 🔒 USER+ | 刪除題目指派 |
