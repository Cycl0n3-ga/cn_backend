...
async function main() {
  ...
  await prisma.testCase.createMany({
    data: [
      ...
      { problemId: twoSum.id, input: "[1,5,8,3,9]\n4", output: "[0,3]", isHidden: true },
    ],
  });
  ...
  await prisma.testCase.createMany({
    data: [
      ...
      { problemId: addTwoNumbers.id, input: "[9,9,9]\n[1]", output: "[0,0,0,1]", isHidden: true },
    ],
  });

  await prisma.testCase.createMany({
    data: [
      { problemId: medianSorted.id, input: "[1,3]\n[2]", output: "2.00000", isHidden: false },
      { problemId: medianSorted.id, input: "[1,2]\n[3,4]", output: "2.50000", isHidden: true },
    ],
  });

  await prisma.testCase.createMany({
    data: [
      { problemId: reverseString.id, input: '["h","e","l","l","o"]', output: '["o","l","l","e","h"]', isHidden: false },
      { problemId: reverseString.id, input: '["H","a","n","n","a","h"]', output: '["h","a","n","n","a","H"]', isHidden: true },
    ],
  });

  await prisma.testCase.createMany({
    data: [
      { problemId: maxSubarray.id, input: "[-2,1,-3,4,-1,2,1,-5,4]", output: "6", isHidden: false },
      { problemId: maxSubarray.id, input: "[1]", output: "1", isHidden: false },
      { problemId: maxSubarray.id, input: "[5,4,-1,7,8]", output: "23", isHidden: true },
    ],
  });
